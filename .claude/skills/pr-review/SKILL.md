---
name: pr-review
description: Operating procedure for the pr-reviewer subagent — mechanical first-pass verification of exactly ONE executor PR against its issue, returning a structured verdict to the orchestrator, who holds sole review authority. Read-only; never posts to GitHub. Preloaded into pr-reviewer; not for the main agent.
